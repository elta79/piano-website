...
function Body(){
    return(
        <div className="flex flex-col flex-grow w-full bg-stone-700 no-scrollbar">
            ...
            <section className="flex flex-col items-center justify-center lg:pl-24 h-dvh">
            ...
            <section className="flex flex-col items-center justify-center h-dvh lg:p-24 ">
